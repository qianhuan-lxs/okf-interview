...
q("backend/microservices/spring-webflux.md",
  "Spring WebFlux (Reactor/Mono/Flux/Netty/背压 + 2026 vs 虚拟线程)",
  "backend", "microservices", "hard",
  ["webflux", "reactor", "reactive-streams", "mono", "flux", "netty",
   "backpressure", "r2dbc", "webclient", "java", "spring", "virtual-thread"],
  [],
  """# Spring WebFlux (Reactor/Mono/Flux/Netty/背压 + 2026 vs 虚拟线程)
...
""",
  ...
  links=["concurrency/coroutine-virtual-thread-principle",
         ...
         "backend/microservices/tomcat-servlet-thread-pool",
