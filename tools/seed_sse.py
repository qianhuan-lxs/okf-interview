...
q("networks/sse-protocol.md",
  "SSE 协议 (规范/AI 流式输出/OpenAI vs Anthropic/SSE vs WebSocket)",
  "networks", "", "medium",
  ["sse", "server-sent-events", "eventsource", "text-event-stream",
   "streaming", "openai", "anthropic", "websocket", "http", "ai"],
  [],
  """# SSE 协议 (规范/AI 流式输出/OpenAI vs Anthropic/SSE vs WebSocket)
...
## 延伸
""",
  languages=[], role=["sde", "backend", "ai-app"],
  source="", status="reviewed", timestamp=DATE,
  links=["networks/okhttpclient-design.md",
         "backend/microservices/spring-webflux.md",
         "ml-ai/agent/agent-memory-management.md",
         "ml-ai/mcp/mcp-protocol-understanding.md"])
