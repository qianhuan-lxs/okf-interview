...
from ikf_writer import q as _q, write, ROOT, SRC
...
def q(*a, **kw):
    """Local wrapper: pin timestamp to this面经's date (2026-05-26)."""
    kw.setdefault("timestamp", DATE)
    return _q(*a, **kw)
...
""",
  links=["ml-ai/mcp/mcp-protocol-understanding",
         "ml-ai/agent/skill-what-and-why"])
...
不行（见 [[ml-ai/agent/skill-what-and-why]]）：
