...
q("ml-ai/observability/claude-code-hooks-implementation.md",
  "Claude Code hooks 的实现机制 (两层模型 / handler / exit code / matcher)",
  "ml-ai", "observability", "hard",
  ["claude-code", "hooks", "implementation", "sdk", "exit-code", "matcher", "agent"],
  [],
  """# Claude Code hooks 的实现机制 (两层模型 / handler / exit code / matcher)
...
## 延伸
""",
  languages=["python", "typescript"], role=["ai-app", "sde", "backend", "devops"],
  source="", status="reviewed",
  links=["ml-ai/observability/claude-code-hooks-observability",
         "ml-ai/observability/codex-opencode-observability",
         "ml-ai/observability/opentelemetry-genai-semantic-conventions",
