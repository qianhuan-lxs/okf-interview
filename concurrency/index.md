...
| 标题 | 难度 | 标签 |
| --- | --- | --- |
| [AQS 原理 (CLH 变体 / state / Condition / 独占共享)](concurrency/aqs-principle.md) | hard | aqs, clh-queue, juc, condition, concurrency |
| [CAS 机制 (cmpxchg + lock 前缀 / Unsafe / ABA / LongAdder)](concurrency/cas-mechanism.md) | hard | cas, compare-and-swap, atomic, aba, unsafe, varhandle |
