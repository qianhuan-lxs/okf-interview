---
type: question
id: concurrency/aqs-based-synchronizers
title: 基于 AQS 的同步器逐一介绍 (Lock/RWLock/Semaphore/CountDownLatch/CyclicBarrier/Worker)
category: concurrency
subcategory: concurrency
difficulty: hard
tags: [aqs, reentrantlock, readwritelock, semaphore, countdownlatch, cyclicbarrier, juc, concurrency]
languages: [java]
role: [sde, backend]
companies: []
source: ""
