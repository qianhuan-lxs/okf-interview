---
type: question
id: concurrency/juc-concurrent-queues
title: JUC 并发队列族 (BlockingQueue / BlockingDeque / 无锁队列设计)
category: concurrency
subcategory: concurrency
difficulty: hard
tags: [blockingqueue, linkedblockingdeque, concurrentlinkedqueue, juc, data-structure, concurrency]
languages: [java]
role: [sde, backend]
companies: []
source: ""
