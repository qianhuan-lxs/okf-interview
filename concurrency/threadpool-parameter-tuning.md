---
type: question
id: concurrency/threadpool-parameter-tuning
title: 线程池参数怎么设 (7 参数 / CPU-IO 公式 / 队列 / 拒绝策略 / 动态调参 / 陷阱)
category: concurrency
subcategory: ""
difficulty: hard
tags: [thread-pool, threadpool, tuning, cpu-bound, io-bound, queue, reject-policy, monitoring, java]
languages: [java]
role: [sde, backend]
companies: []
source: ""
