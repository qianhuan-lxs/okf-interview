...
| 标题 | 难度 | 标签 |
| --- | --- | --- |
| [Agent 上下文记忆管理 (Memory)](ml-ai/agent/agent-memory-management.md) | medium | memory, short-term, long-term, context-management |
| [Agent 工具调用机制 (Function Call 原理)](ml-ai/agent/agent-function-call-mechanism.md) | medium | function-call, tool-calling, llm, json-schema |
...
| [Skill 的含义 / 加载机制 / 自进化](ml-ai/agent/skill-meaning-loading-evolution.md) | hard | skill, prompt-engineering, loading, self-evolution, hermes, gepa, dspy |
...
- [[ml-ai/mcp/mcp-protocol-understanding]] — MCP 协议理解 (解决什么问题)
- [[ml-ai/mcp/mcp-vs-a2a-difference]] — MCP vs A2A 区别
