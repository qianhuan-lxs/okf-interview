---
type: question
id: networks/okhttpclient-design
title: OkHttpClient 设计 (拦截器链 / 连接池 / Dispatcher / Okio)
category: networks
subcategory: networks
difficulty: hard
tags: [okhttp, http-client, interceptor, connection-pool, dispatcher, okio, design-pattern, android]
languages: [java, kotlin]
role: [sde, backend, android]
companies: []
source: ""
status: reviewed
...
- 关联题：[[networks/tcp-handshake-teardown]]
- 关联题：[[concurrency/thread-pool-principles]]
- 关联题：[[concurrency/juc-concurrent-queues]]
