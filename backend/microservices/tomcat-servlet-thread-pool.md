---
type: question
id: backend/microservices/tomcat-servlet-thread-pool
title: Tomcat Servlet 线程池 (acceptCount/maxConnections/maxThreads/TaskQueue/NIO)
category: backend
subcategory: microservices
difficulty: hard
tags: [tomcat, servlet, thread-pool, taskqueue, nio, acceptCount, maxConnections, maxThreads, virtual-thread, java]
languages: [java]
role: [sde, backend]
companies: []
source: ""
